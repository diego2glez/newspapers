#!/bin/bash
fecha=$(date +"%Y%m%d")
directoryPath="/home/vnc/Escritorio/Periodicos/MX-ElSolDeMexico/"
#directoryPath="/tmp/BOL-Cambio/"
pdfName="SolDeMexico_${fecha}"
...
urlsFilePath="${directoryPath}URLs.txt"
	...
	#Run Selenium jar
	xvfb-run -a java -jar /home/vnc/Escritorio/Periodicos/Scripts/SolDeMexicoDownloader.jar ${directoryPath} >& /tmp/salidaSolDeMexicoXVFB.log
