...
public class FrankfurterDownloader {
	...
	public static void main(String[] args) {
		...
		driver.get(FrankfurterUrl + "FAZ/" + currentDate1);

		WebDriverWait wait = new WebDriverWait(driver, 30);

		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//img[@alt='F.A.Z.']")));

		// 3. Login
		driver.findElement(By.xpath("//img[@alt='F.A.Z.']")).click();
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//img[contains(@alt,\"F.A.Z\")]")));

		WebElement imgLink = driver.findElement(By.xpath("//img[contains(@alt,\"F.A.Z\")]"));
